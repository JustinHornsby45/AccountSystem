...
public class AccountTransactionDto extends AccountTypeDto implements Serializable {
    ...
    public AccountTransactionDto(AccountTransactionDto accountTransactionDetailsDto) {
    }
